...
d3.csv('trial4.csv', function (data) {
    ...
    var dayOfWeek = ndx.dimension(function (d) {
        ...
        var name = ['Manufacturing', 'Construction', 'Services', 'Wholesale & Retail Trade', 'Transportation and Storage', 'Accomodation and Food Services', 'Information and Communications','Financial and Insurance ServicesÊ', 'Real Estate Services', 'Professional Services','Administrative and Support Services', 'Community & Personal Services'];//Huiwen
